...
<tr>
    <td class="text" align="center"
        colspan="4"><?php echo $lang_mybonus['text_exchange_your_karma'] ?><?php echo $bonus ?><?php echo $lang_mybonus['text_for_goodies'] ?>
...
<table width="940" cellpadding="3">
    <tr>
        <td class="colhead" align="center"><font class="big"><?php echo $lang_mybonus['text_what_is_karma'] ?></font>
        </td>
    </tr>
    <tr>
...
<table width="940" cellpadding="3">
    <tr>
        <td class="colhead" align="center"><font class="big">魔力值历史记录(不包含种子评分)</font></td>
    </tr>
    <tr>
        <td class="text" align="center">
            <?php
