	...
	if($CURUSER['showdlnotice']>=1&&!$questinguser&&$bakatype=='question'||$CURUSER['addbonus'] <= TIMENOW&&$bakatype=='dayper'&&!$questinguser)//未抽题
{
	...
	$Cache->delete_value('user_get_baka_'.$CURUSER["id"].'_wrongbefore');
		...
		stderr('PT使用资格认证考试',"为了让您更好的使用MoeCatPT,下载资源前先要进行一些简单的测试<br />测试答案可以到论坛相关板块 , <a href='rules.php'><b>网站规则</b></a> , <a href='faq.php'><b>常见问题</b></a> 等处查找<br />这货不是签到!<a href='".$_SERVER['PHP_SELF']."'><b>开始测试</b></a>",false);
}
