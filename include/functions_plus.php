...
function menu ($selected = "home") {
	...
	<a class=\"normalMenu\"  href=\"forums.php\">&nbsp;MoeCat学园&nbsp;</a>
	...
	<a  href=\"forums.php\" class=\"normalMenu\">&nbsp;MoeCat学园&nbsp;</a></li>");
...
<div style=\"display: none;\" id=\"curtain\" class=\"curtain\" onclick=\"Return();\" onmousewheel=\"return false;\" ></div>");
	...
	print("\n<span style=\"display: none\"><img src=\"https://www.baidu.com/search/img/logo.gif?".lcg_value()."\" onError=\"javascript:linestate('error')\" onLoad=\"javascript:linestate('success');\"/></span>");
...
static $doubanapikeyextension = array('02646d3fb69a52ff072d47bf23cef8fd','0b2bdeda43b5688921839c8ecb20399b','0dad551ec0f84ed02907ff5c42e8ec70','0df993c66c0c636e29ecbb5344252a4a');
...
$xml=file_get_contents_function("http://dean.swjtu.edu.cn/servlet/DeanStudentLoginAction?UserName=$deannumber&Password=$deanpassword&AttestationUser=SWJTU-DEAN-USER-0001&AttestationPassword=E2G3-J5K3-T4S7M0-B5N2");
else
$xml=file_get_contents_function("http://dean.swjtu.edu.cn/servlet/DeanTeacherLoginAction?UserName=$deannumber&Password=$deanpassword&AttestationUser=SWJTU-DEAN-USER-0001&AttestationPassword=E2G3-J5K3-T4S7M0-B5N2");
